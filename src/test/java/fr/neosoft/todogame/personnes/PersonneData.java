...
public class PersonneData {
    ...
    public static final Personne BON_JEAN = getNewPersonne(2L, "Bon","Jean","jeanBon@yopmail.fr","jeanBon","$2a$10$sEebmn5b2WV1jNXJtrTdOO0r.s1PCzdhuIN2K5jxqzSj25Kah1x/S", 200, new Role(1L, "PERSONNE"));
