...
public class DefiData {
    ...
    public static Defi DEFI_1 = new Defi(1L, "Défi 1", "Description du défi 1", TypeDefi.QUOTIDIEN, 50, 0, 10, null, null);
    public static Defi DEFI_2 = new Defi(2L, "Défi 2", "Description du défi 2", TypeDefi.HEBDOMADAIRE, 100, 200, 2, null, null);
    public static Defi DEFI_3 = new Defi(3L, "Défi 3", "Description du défi 3", TypeDefi.MENSUEL, 200, 500, 10, null, null);
    ...
    public static List<DefiPersonne> addListDefiPersonneToPersonne(Personne personne) {
        return List.of(
